...
Meeus, Sofie et al. 2023. ‘More than a Bit of Fun: The Multiple Outcomes of a Bioblitz’. BioScience 73(3): 168–81.


## Paquetes de R de interés

## Herramientas
Para elegir paletas de colores: [R color brewer](https://colorbrewer2.org/)


## Conjuntos de datos

Global datasets such as those from the [World Bank](https://data.worldbank.org/).
